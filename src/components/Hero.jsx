            ...
            >
                ...
                <div className="container mx-auto relative flex flex-col lg:flex-row py-10 px-6">
                    ...
                    <div className="lg:w-[30%]">
                        ...
                        <div className="flex flex-col lg:h-full gap-4 text-lightOrange py-8 mt-[90px]">
                            <motion.h1
                                ...
                                className="text-6xl md:text-7xl ml-[30px] md:ml-[40px] w-[250px] md:w-[300px] leading-[80px] "
                            >
                                Blvk Tumbler
                            </motion.h1>
                            <motion.p
                                ...
                                className="opacity-55 text-sm font-light leading-loose  text-lightOrange w-[300px] md:w-[350px] mt-4 lg:mt-[100px] md:mt-5"
                            >
                                <span className="block text-[20px] text-primary pb-4">
                                    Black Lifestyle lovers
                                </span>
                                Where the aroma is rich, the
                    ...
                    <div className="flex flex-col lg:w-[70%] lg:flex-row justify-normal gap-6">
                        <div className="relative flex justify-center items-center lg:w-full">
                            ...
                            <motion.div
                                ...
                                className="absolute h-[180px] w-[180px] sm:h-[220px] sm:w-[220px] md:w-[320px] md:h-[320px]  top-[50px] -right-0 sm:right-[90px] sm:top-[60px] lg:w-[200px] lg:h-[200px] lg:left-[280px] lg:top-[90px]   border-primary border-[20px] rounded-full z-10"
                            ></motion.div>
                        </div>
                        <div className="flex items-center md:justify-end lg:w-full lg:justify-end mt-2 py-4">
                            <motion.div
                                ...
                                className="w-[320px] md:w-[350px] md:px-4 lg:mt-[180px]">
                    ...
                    <motion.div
                        ...
                        className="absolute top-[50px] left-[190px] sm:top-[50px] sm:left-[400px] lg:top-[80px] lg:left-[690px] z-[1]"
                    >
                ...
                {isOpen && (
                    <motion.div 
                        ...
                        className="absolute top-0 right-0 h-screen w-[110px] overflow-y-auto  bg-gradient-to-b from-primary/80 to to-primaryDark/80 backdrop:blur-sm z-10">
